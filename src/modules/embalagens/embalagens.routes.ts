...
import * as service from './embalagens.service';
import { createEmbalagemSchema, updateEmbalagemSchema } from './embalagens.schema';
...
router.post(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = createEmbalagemSchema.parse(req.body);
...
router.put(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = updateEmbalagemSchema.parse(req.body);
